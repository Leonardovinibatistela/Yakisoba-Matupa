...
export default function IngredientsPanel({ ingredients, ingredientPurchases, recipes, onAddIngredient, onRenameIngredient, onRegisterPurchase, onAdjustStock, onSetMinStock, onSetCategory, onDeleteIngredient, onEditPurchase, onDeletePurchase }: { ingredients: Ingredient[]; ingredientPurchases: IngredientPurchase[]; recipes: Recipes; onAddIngredient: (name: string, unit: IngredientUnit, category: string | null) => Promise<void>; onRenameIngredient: (ingredientId: string, name: string) => Promise<void>; onRegisterPurchase: (ingredientId: string, quantity: number, totalCost: number) => Promise<void>; onAdjustStock: (ingredientId: string, newStock: number) => Promise<void>; onSetMinStock: (ingredientId: string, minStock: number | null) => Promise<void>; onSetCategory: (ingredientId: string, category: string | null) => Promise<void>; onDeleteIngredient: (ingredientId: string) => Promise<void>; onEditPurchase: (purchase: IngredientPurchase, newQuantity: number, newTotalCost: number) => Promise<void>; onDeletePurchase: (purchase: IngredientPurchase) => Promise<void> }) {
