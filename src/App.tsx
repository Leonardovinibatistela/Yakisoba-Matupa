...
export default function App() {
  ...
  const checkout = () => {
    ...
    const buildMessage = () => [
      ...
      ...itemLines,
      "",
      deliveryType === "entrega" ? `Entrega (+ ${formatTotal(DELIVERY_FEE)})\n📍 Rua: ${location.trim()}, nº ${houseNumber.trim()} - Bairro: ${neighborhood.trim()}` : `Retirar no local\nLocal de retirada: ${STORE_PICKUP_LABEL}`,
      `Talher: ${cutleryLabel}`,
    ...
    const orderPayload: OrderPayload = {
      ...
      total,
      deliveryType,
      location: deliveryType === "entrega" ? `${location.trim()}, nº ${houseNumber.trim()} - ${neighborhood.trim()}` : location,
      cutlery,
      paymentMethod,
      notes: notes.trim(),
    };
