...
function MenuVariantRow({ items, quantities, setQuantity, soldOutIds, priceOverrides, photoOverrides, nameOverrides }: { items: MenuItem[]; quantities: Record<string, number>; setQuantity: (id: string, nextQuantity: number) => void; soldOutIds: Set<string>; priceOverrides: Record<string, number>; photoOverrides: Record<string, string>; nameOverrides: Record<string, string> }) {
