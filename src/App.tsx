...
function MenuSectionView({ quantities, setQuantity, activeSection, changeSection, cartItems, subtotal, total, checkout, deliveryType, setDeliveryType, deliveryFee, cutlery, setCutlery, paymentMethod, setPaymentMethod, pixCopied, setPixCopied, storeOpen, emergencyPaused, notes, setNotes, customerName, setCustomerName, customerPhone, setCustomerPhone, location, setLocation, houseNumber, setHouseNumber, requestLocation, locatingGps, soldOutIds, priceOverrides, photoOverrides, customItems }: { quantities: Record<string, number>; setQuantity: (id: string, nextQuantity: number) => void; activeSection: string; changeSection: (id: string) => void; cartItems: CartLine[]; subtotal: number; total: number; checkout: () => void; deliveryType: "retirada" | "entrega"; setDeliveryType: (value: "retirada" | "entrega") => void; deliveryFee: number; cutlery: "hashi" | "garfo" | "nenhum"; setCutlery: (value: "hashi" | "garfo" | "nenhum") => void; paymentMethod: "pix" | "cartao" | "dinheiro"; setPaymentMethod: (value: "pix" | "cartao" | "dinheiro") => void; pixCopied: boolean; setPixCopied: (value: boolean) => void; storeOpen: boolean; emergencyPaused: boolean; notes: string; setNotes: (value: string) => void; customerName: string; setCustomerName: (value: string) => void; customerPhone: string; setCustomerPhone: (value: string) => void; location: string; setLocation: (value: string) => void; houseNumber: string; setHouseNumber: (value: string) => void; requestLocation: () => void; locatingGps: boolean; soldOutIds: Set<string>; priceOverrides: Record<string, number>; photoOverrides: Record<string, string>; customItems: CustomMenuItem[] }) {
  ...
  // na seção certa — pro público, é tudo um cardápio só.
  const mergedSections = menuSections.map((section) => ({ ...section, items: [...section.items, ...customItems.filter((item) => item.sectionId === section.id).map(fromCustomItem)] }));
