...
export default function App() {
  ...
  const checkout = () => {
    ...
    if (deliveryType === "entrega" && !houseNumber.trim()) return;
    ...
    const orderPayload: OrderPayload = {
      ...
      total,
      deliveryType,
      location: deliveryType === "entrega" && houseNumber.trim() ? `${location} (Nº ${houseNumber.trim()})` : location,
      cutlery,
      paymentMethod,
      notes: notes.trim(),
    };
...
function MenuSectionView({ quantities, setQuantity, addYakiInstance, removeYakiInstance, activeSection, changeSection, cartItems, subtotal, total, checkout, deliveryType, setDeliveryType, deliveryFee, cutlery, setCutlery, paymentMethod, setPaymentMethod, pixCopied, setPixCopied, storeOpen, emergencyPaused, notes, setNotes, customerName, setCustomerName, customerPhone, setCustomerPhone, location, setLocation, houseNumber, setHouseNumber, requestLocation, locatingGps, soldOutIds, priceOverrides, photoOverrides, nameOverrides, descriptionOverrides, customItems, hiddenIds }: { quantities: Record<string, number>; setQuantity: (id: string, nextQuantity: number) => void; addYakiInstance: (baseId: string) => void; removeYakiInstance: (instanceId: string) => void; activeSection: string; changeSection: (id: string) => void; cartItems: CartLine[]; subtotal: number; total: number; checkout: () => void; deliveryType: "retirada" | "entrega"; setDeliveryType: (value: "retirada" | "entrega") => void; deliveryFee: number; cutlery: "hashi" | "garfo" | "nenhum"; setCutlery: (value: "hashi" | "garfo" | "nenhum") => void; paymentMethod: "pix" | "cartao" | "dinheiro"; setPaymentMethod: (value: "pix" | "cartao" | "dinheiro") => void; pixCopied: boolean; setPixCopied: (value: boolean) => void; storeOpen: boolean; emergencyPaused: boolean; notes: string; setNotes: (value: string) => void; customerName: string; setCustomerName: (value: string) => void; customerPhone: string; setCustomerPhone: (value: string) => void; location: string; setLocation: (value: string) => void; houseNumber: string; setHouseNumber: (value: string) => void; requestLocation: () => void; locatingGps: boolean; soldOutIds: Set<string>; priceOverrides: Record<string, number>; photoOverrides: Record<string, string>; nameOverrides: Record<string, string>; descriptionOverrides: Record<string, string>; customItems: CustomMenuItem[]; hiddenIds: Set<string> }) {
...
function CartSummary({ cartItems, quantities, subtotal, total, onQuantityChange, onRemoveYakiInstance, onCheckout, compact, deliveryType, setDeliveryType, deliveryFee, cutlery, setCutlery, paymentMethod, setPaymentMethod, pixCopied, setPixCopied, storeOpen, emergencyPaused, notes, setNotes, customerName, setCustomerName, customerPhone, setCustomerPhone, location, setLocation, houseNumber, setHouseNumber, requestLocation, locatingGps }: { cartItems: CartLine[]; quantities: Record<string, number>; subtotal: number; total: number; onQuantityChange: (id: string, nextQuantity: number) => void; onRemoveYakiInstance: (instanceId: string) => void; onCheckout: () => void; compact: boolean; deliveryType: "retirada" | "entrega"; setDeliveryType: (value: "retirada" | "entrega") => void; deliveryFee: number; cutlery: "hashi" | "garfo" | "nenhum"; setCutlery: (value: "hashi" | "garfo" | "nenhum") => void; paymentMethod: "pix" | "cartao" | "dinheiro"; setPaymentMethod: (value: "pix" | "cartao" | "dinheiro") => void; pixCopied: boolean; setPixCopied: (value: boolean) => void; storeOpen: boolean; emergencyPaused: boolean; notes: string; setNotes: (value: string) => void; customerName: string; setCustomerName: (value: string) => void; customerPhone: string; setCustomerPhone: (value: string) => void; location: string; setLocation: (value: string) => void; houseNumber: string; setHouseNumber: (value: string) => void; requestLocation: () => void; locatingGps: boolean }) {
